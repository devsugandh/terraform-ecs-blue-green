...
module "pipeline_roles" {
  ...
  managed_codepipeline_rolename = "shangwellness_managed_codepipeline_execution_role"
  managed_codebuild_rolename    = "shangwellness_managed_codebuild_execution_role"
  managed_codedeploy_rolename   = "shangwellness_managed_codedeploy_execution_role"
...
module "build_stages" {
  ...
  codebuild_project_name = "Shangwellness-Service-Build"
