...
variable "private_subnet_cidr_all" {
  ...
  type        = list(string)
  default     = ["15.0.0.0/19", "15.0.32.0/19"]
}
...
variable "ecs_task_role" {
  ...
  default     = "shangwellness_managed_ecs_task_role"
}

variable "ecs_task_execution_role" {
  type        = string
  description = "ECS Service Role name"
  default     = "shangwellness_managed_ecs_task_execution_role"
}

variable "iam_role_name" {
  type        = string
  description = "IAM Role name"
  default     = "shangwellness_managed_ecs_role"
}

variable "ecs_codedeploy_roles" {
  type    = string
  default = "shangwellness_managed_ecs_codedeploy_role"
}
...
variable "ecs_cluster_name" {
  ...
  default     = "shangwellnessProdcluster"
}

variable "ecs_service_role" {
  type        = string
  description = "ECS Service Role name"
  default     = "shangwellness_managed_ecs_service_roles"
}

variable "ecs_service_name" {
  type        = string
  description = "ECS Service name"
  default     = "shangwellness-service"
}
...
variable "s3_bucket_name" {
  type    = string
  default = "shangwellness-app-codepipeline"
}