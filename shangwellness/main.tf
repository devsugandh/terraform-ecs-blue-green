...
module "defaultSecGroup_Public" {
  ...
  sec_groups_name        = "Shangwellness-SecurityGroup-Public"
  sec_groups_description = "Shangwellness Security Group with Public Access"
  ...
  tags = {
    Name      = "Shangwellness-SecurityGroup-Public"
    ManagedBy = "Terraform"
  }
}
...
module "defaultSecGroup_PrivateOnly" {
  ...
  count                  = var.create_security_groups ? 1 : 0
  sec_groups_name        = "Shangwellness-SecurityGroup-PrivateOnly"
  sec_groups_description = "Shangwellness Security Group with Private Access"
  vpc_id                 = module.vpc.vpc_id
  revoke_rules_on_delete = var.revoke_rules_on_delete
  ingress_with_self = [
    {
  ...
  # ]
  tags = {
    Name      = "Shangwellness-SecurityGroup-Private"
    ManagedBy = "Terraform"
  }
}
